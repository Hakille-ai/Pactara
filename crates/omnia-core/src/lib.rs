...
impl TryFrom<&str> for PactStatus {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            other => Err(OmniaCoreError::UnknownStatus(other.to_string())),
        }
    }
}
...
impl Pact {
    pub fn new(request: CreatePactRequest) -> Self {
        let now = Utc::now();
        let expires_at = request.expires_at.unwrap_or_else(|| now + Duration::days(30));
        Self {
            id: Uuid::new_v4(),
            actor: request.actor,
    ...
    pub fn from_identity(identity: &Identity) -> Self {
        ...
        Self {
            context: vec![
                ...
                "https://omnia.protocol/ns/v0.3".to_string(),
            ],
            ...
            service: vec![DidService {
                id: format!("{}#omnia-api", identity.id),
                service_type: "OmniaProtocolAPI".to_string(),
...
pub struct AuthChallenge {
    pub id: Uuid,
    pub identity_id: Option<OmniaId>,
    pub purpose: String,
...
pub struct AgentTask {
    ...
    pub approved_by: Option<OmniaId>,
    pub created_at: DateTime<Utc>,
