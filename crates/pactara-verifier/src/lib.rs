use chrono::Utc;
use pactara_core::{BundleVerificationResponse, PactBundle, PactStatus};
...
mod tests {
    ...
    use pactara_crypto::{generate_key_material, hash_value, sign_value};
    use serde_json::json;
    use uuid::Uuid;
    ...
    fn signed_bundle() -> PactBundle {
        ...
        let mut pact = Pact::new(CreatePactRequest {
            actor: "pactara:person:alice".to_string(),
        ...
        PactBundle {
            ...
            actor: IdentityPublic {
                ...
                kind: pactara_core::IdentityKind::Person,
